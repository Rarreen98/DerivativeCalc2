...
import mitchell_erik.calculus.derivativecalc.calculations.Derivative;
...
public class Main
{
	...
	private void initialize()
	{
		...
		btnCalculate.addActionListener(new ActionListener()
		{
			...
			{
				String function = "";
				if(denominatorInput.getText() == null ||denominatorInput.getText().equals("1"))
					function = numeratorInput.getText();
				else
					function = "(" + numeratorInput.getText() + ")/(" + denominatorInput.getText() + ")";
				List<String> result = Derivative.getDerivative(function);
				numeratorOutput.setText(result.get(0));
				denominatorOutput.setText(result.get(1));
			}
		});
